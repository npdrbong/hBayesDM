...
__all__ = ['omsfree_ewmv']


class OmsfreeEwmv(TaskModel):
...
def omsfree_ewmv(
    ...
    """Balloon Analogue Risk Task, one more step version - one more step version. Exponential-Weight Mean-Variance Model

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task, one more step version 
    using one more step version. Exponential-Weight Mean-Variance Model [Park2020]_ with the following parameters:
    "phi" (prior belief of burst), "eta" (updating exponent), "rho" (risk preference), "tau" (inverse temperature), "lambda" (loss aversion), "epsi" (free parameter for 'one more step').
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('omsfree_ewmv').
    ...
    .. code:: python
        ...
        output = omsfree_ewmv(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
