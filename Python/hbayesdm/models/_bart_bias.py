...
def bart_bias(
    ...
    """Balloon Analogue Risk Task - Bayesian updating of risk rewritten with 'Bias' term

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Bayesian updating of risk rewritten with 'Bias' term [Kim2020]_ with the following parameters:
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_bias').
    ...
    .. code:: python
        ...
        output = bart_bias(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
