...
def bart_target(
    ...
    "phi" (parameter for initial target number), "tau" (inverse temperature), "vwin" (learning rate of reward), "vloss" (learning rate of loss).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_target').
    ...
    .. code:: python
        ...
        output = bart_target(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
