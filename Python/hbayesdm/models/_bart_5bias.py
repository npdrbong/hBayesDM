...
def bart_5bias(
    ...
    """Balloon Analogue Risk Task - Bayesian updating of risk rewritten with 'Bias' term, with 'gam'

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Bayesian updating of risk rewritten with 'Bias' term, with 'gam' [Kim2020]_ with the following parameters:
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_5bias').
    ...
    .. code:: python
        ...
        output = bart_5bias(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
