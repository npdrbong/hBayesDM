    ...
    def __init__(self, **kwargs):
        super().__init__(
            ...
            parameters_desc=OrderedDict([
                ('phi', 'parameter for initial target number'),
                ('tau', 'inverse temperature'),
                ('vwin', 'learning rate of reward'),
                ('vloss', 'learning rate of loss'),
                ('alpha', 'sensitivity of reward'),
                ('beta', 'sensitivity of loss'),
            ]),
...
def bart_rl(
    ...
    """Balloon Analogue Risk Task - reinforcement learning from target model

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using reinforcement learning from target model [van_Ravenzwaaij2011]_ with the following parameters:
    "phi" (parameter for initial target number), "tau" (inverse temperature), "vwin" (learning rate of reward), "vloss" (learning rate of loss), "alpha" (sensitivity of reward), "beta" (sensitivity of loss).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_rl').
    ...
    .. code:: python
        ...
        output = bart_rl(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
