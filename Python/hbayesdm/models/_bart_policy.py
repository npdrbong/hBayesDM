...
def bart_policy(
    ...
    """Balloon Analogue Risk Task - policy optimization based on target model

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using policy optimization based on target model [van_Ravenzwaaij2011]_ with the following parameters:
    "phi" (parameter for initial target number), "tau" (inverse temperature), "alpha" (learning rate).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_policy').
    ...
    .. code:: python
        ...
        output = bart_policy(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
