...
def oms_bias(
    ...
    """Balloon Analogue Risk Task, one more step version - one more step version. Bayesian updating of risk rewritten with 'Bias' term

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task, one more step version 
    using one more step version. Bayesian updating of risk rewritten with 'Bias' term [Kim2020]_ with the following parameters:
    "phi" (prior belief of balloon not bursting), "tau" (inverse temperature), "alpha" (Learning Bias), "beta" (Perceptual Bias).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('oms_bias').
    ...
    .. code:: python
        ...
        output = oms_bias(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
