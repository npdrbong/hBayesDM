#' @templateVar MODEL_FUNCTION oms_bias
...
#' @templateVar MODEL_NAME one more step version. Bayesian updating of risk rewritten with 'Bias' term
#' @templateVar MODEL_CODE bias
#' @templateVar MODEL_CITE (Kim et al., 2020)
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion", "oms"
#' @templateVar PARAMETERS \code{phi} (prior belief of balloon not bursting), \code{tau} (inverse temperature), \code{alpha} (Learning Bias), \code{beta} (Perceptual Bias)
